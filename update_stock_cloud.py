...
def main():
    ...
    for p in products:
        ...
        # Escape: von Hand ARCHIVIERT (ohne Auto-Tag) NIE reaktivieren. Bis 24.09.2026 holte
        # der Sync jedes archivierte Produkt mit Bestand zurueck (Kiefer-Dubletten 24.09.,
        # 23 Titel-Dubletten 16.08.). Auto-archivierte Restposten tragen TAG_HIDDEN_SORT
